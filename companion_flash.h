...
#define COMPANION_FILE_HEADER_MAGIC1 0xAB
#define COMPANION_FILE_HEADER_MAGIC2 0xCD
#define COMPANION_FILE_HEADER_COMPANION_VERSION 1
#define COMPANION_FILE_HEADER_SAVE_VERSION 1
#define COMPANION_FILE_HEADER_SAMPLE_RATE 1000
#define DEBUG_NUKE_STORAGE 0
